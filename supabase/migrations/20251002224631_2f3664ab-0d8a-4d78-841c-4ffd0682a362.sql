-- Fix accept_invitation_secure function to remove reference to non-existent updated_at column
...
EXCEPTION
    WHEN OTHERS THEN
        ...
        RAISE LOG 'Error in accept_invitation_secure: % - SQLSTATE: %', SQLERRM, SQLSTATE;
