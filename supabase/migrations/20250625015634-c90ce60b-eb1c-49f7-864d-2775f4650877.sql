...
-- Update the function to treat null visibility as public for shared rundowns
...
DECLARE
  layout_data jsonb;
BEGIN
  -- Check if the rundown is public (or has null visibility) and has the specified layout shared
  IF NOT EXISTS (
    SELECT 1 
    FROM rundowns r
