-- Update the remove_team_member_with_transfer function to NOT delete user accounts
...
BEGIN
  ...
  -- NOTE: We do NOT delete the user's profile or auth account
  -- They retain their personal team and can still access the system
  ...
  -- Return summary of what was transferred (NO user_id_to_delete)
