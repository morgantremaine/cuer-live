-- Fix create_rundown_revision function to properly handle all table columns
...
BEGIN
  ...
  IF should_create_revision THEN
    -- Explicitly specify all columns to avoid mismatch errors
    ...
    VALUES (
      ...
      CASE 
        ...
        ELSE 'auto'
      END,
      new_item_count  -- Include the items_count column
    );
  END IF;
