...
-- Update the remove_team_member_with_transfer function to properly delete auth users
...
BEGIN
  ...
  -- Delete the user from auth.users (this requires service role privileges)
