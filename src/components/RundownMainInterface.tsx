...
import CuerChatButton from './cuer/CuerChatButton';
...
interface RundownMainInterfaceProps {
  savedRundowns: any[];
  loading: boolean;
}

const RundownMainInterface = ({ savedRundowns, loading }: RundownMainInterfaceProps) => {
...
export default RundownMainInterface;
