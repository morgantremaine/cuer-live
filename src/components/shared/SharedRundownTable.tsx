              ...
              return (
                <tr
                  ...
                  className={`
                    ...
                    ${isShowcallerCurrent ? 'bg-muted !border-l-6 !border-blue-600 !border-2 !border-blue-600 shadow-xl shadow-blue-500/50 relative z-10 transform transition-all duration-200' : ''}
