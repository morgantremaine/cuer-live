...
const TextAreaCell = ({
  ...
  const [calculatedHeight, setCalculatedHeight] = useState<number>(30);
  ...
  return (
    <div className="relative w-full" style={{ backgroundColor, height: calculatedHeight }}>
      ...
      {shouldShowClickableUrls && (
        <div
          className={`absolute top-0 left-0 w-full h-full px-3 py-1 ${fontSize} ${fontWeight} whitespace-pre-wrap pointer-events-none z-10`}
          style={{ 
      ...
      <textarea
        ...
        className={`w-full h-full px-3 py-1 ${fontSize} ${fontWeight} whitespace-pre-wrap border-0 focus:border-0 focus:outline-none rounded-sm resize-none overflow-hidden ${
