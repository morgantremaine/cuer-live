              ...
              <div className="flex border border-gray-300 dark:border-gray-600 rounded overflow-hidden">
                <Popover open={isTimePickerOpen} onOpenChange={setIsTimePickerOpen}>
                  <PopoverTrigger asChild>
                    <button
                      className="h-8 px-3 font-mono text-sm bg-transparent hover:bg-accent hover:text-accent-foreground cursor-pointer transition-colors"
                    >
          ...
          <div className="flex items-center space-x-2">
            <div className="flex border border-gray-300 dark:border-gray-600 rounded overflow-hidden">
              <Popover open={isTimePickerOpen} onOpenChange={setIsTimePickerOpen}>
                <PopoverTrigger asChild>
              <button
                className="h-9 px-3 font-mono text-sm bg-transparent hover:bg-accent hover:text-accent-foreground cursor-pointer transition-colors"
              >
                {formatClockTime(rundownStartTime)}
              </button>
                </PopoverTrigger>
