            ...
            <table className="w-full">
              <tbody>
                {sections.map((section, index) => {
                  ...
                  return (
                    <>
                      {/* Header Row - matches rundown styling with proper semantic tokens */}
                      ...
                      {/* Summary Row */}
                      <tr key={`summary-${sectionKey}`} className="border-b border-border bg-background hover:bg-muted/50 transition-colors">
                        <td className="px-4 py-4">
                          {summary?.isLoading ? (
                            ...
                            <div className="text-muted-foreground text-sm italic opacity-60">
