      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pb-24">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-slate-400">Live showcaller controls keep your whole crew in sync and on time, while floating and real-time rundown-to-prompter on-air updates seamless.</p>
          </div>
        </div>
