...
const LandingPage = () => {
  ...
  return (
    <>
      ...
      <link rel="preload" as="image" href="/lovable-uploads/320be22d-bf0c-4ecd-a511-e4ab41452546.png" />
      ...
      <div className="relative z-10 w-full pb-24">
        ...
        <div className="relative mb-16 w-full">
          ...
          <div className="absolute inset-0 w-full">
            <img 
              src="/lovable-uploads/320be22d-bf0c-4ecd-a511-e4ab41452546.png" 
          ...
          <div className="relative z-10 text-center space-y-8 py-24 px-8 max-w-7xl mx-auto">
            ...
            <div className="text-center fade-up">
              <p className="text-base text-slate-300">
                Use code <code className="bg-slate-800/50 text-blue-300 px-2 py-1 rounded font-mono text-lg border border-slate-700">FREEMONTH</code> to get 1 month free on any monthly plan
              </p>
            </div>
          </div>
        </div>
