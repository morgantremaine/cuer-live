...
const PlaybackControls = ({
  ...
  return (
    <div className="flex items-center space-x-1">
      ...
      {onToggleAutoScroll && (
        <div 
          className={`flex items-center space-x-1.5 px-2 rounded-md border border-input bg-background hover:bg-accent hover:text-accent-foreground ml-2 cursor-pointer ${
            size === 'sm' ? 'h-9' : 'h-10'
          }`}
