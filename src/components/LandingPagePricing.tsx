...
import { Crown, Users, ChevronLeft, ChevronRight, UserPlus, Infinity, Zap, Bot, Headphones, UserCheck, FileText, Share, Monitor, Tv, Sparkles, Package, Clock } from 'lucide-react';
...
const PLANS = [
  ...
  },
  {
    ...
    monthlyPrice: 75,
    yearlyPrice: 810, // 10% off: 75 * 12 * 0.9 = 810
    features: [
