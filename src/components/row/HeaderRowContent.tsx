...
const HeaderRowContent = ({
  ...
  return (
    <>
      ...
      <td 
        className="px-3 py-6 text-xl font-mono font-semibold align-middle border-t-[0.5px] border-b-[0.5px] border-border min-h-[96px]"
        style={{ 
          backgroundColor,
          width: '64px',
          minWidth: '64px', 
      ...
      {columns.map((column, columnIndex) => {
        ...
        if (columnIndex === 0) {
          ...
          return (
            <td
              key={column.id}
              className="align-middle border-t-[0.5px] border-b-[0.5px] border-border min-h-[96px] relative"
              style={{ 
                width: columnWidth, 
          ...
          return (
            <td
              key={column.id}
              className="align-middle border-t-[0.5px] border-b-[0.5px] border-border min-h-[96px]"
              style={{ 
                width: columnWidth, 
                minWidth: columnWidth,
