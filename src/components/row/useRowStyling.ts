...
export const useRowStyling = ({
  ...
  if (isDragging) {
    ...
    rowClass = 'bg-muted !border-l-8 !border-blue-600 !border-4 !border-blue-600 shadow-xl shadow-blue-500/50 relative z-10 transform transition-all duration-200 my-2';
