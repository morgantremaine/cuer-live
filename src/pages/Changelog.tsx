                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <ul className="text-gray-300 list-disc list-inside space-y-2 mb-3">
                      ...
                      <li><strong>Quick Insert:</strong> Press Alt + 1-9 (Windows) or Cmd + Shift + 1-9 (Mac) to instantly insert talent badges into any text field</li>
                    ...
                    <div className="bg-slate-900/50 rounded-lg p-4 border border-slate-600">
                      <img 
                        ...
                        alt="Talent Quick-Insert dialog showing 9 preset slots with keyboard shortcuts Alt+1-9 (Windows) or Cmd+Shift+1-9 (Mac)"
