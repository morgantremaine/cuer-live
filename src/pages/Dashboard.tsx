    ...
    return (
      <div className="min-h-screen bg-neutral-950 flex flex-col">
        ...
        <div className="flex flex-1">
          <div className="w-80 bg-black border-r border-neutral-800 p-4">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <CSVImportDialog onImport={handleCSVImport}>
                    <Button 
                      size="lg" 
                      variant="outline"
                      className="bg-neutral-800 hover:bg-neutral-700 text-white hover:text-white border-neutral-700"
                    >
