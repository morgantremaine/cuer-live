      ...
      <RundownLayoutWrapper>
        <div className="max-w-4xl mx-auto py-8 px-4">
          ...
          <div className="space-y-8">
            {/* Getting Started */}
            <section className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border dark:border-gray-700">
            ...
            <section className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border dark:border-gray-700">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
                <MousePointer className="h-6 w-6 mr-2 text-green-600 dark:text-green-400" />
                Basic Operations
              </h2>
            ...
            <section className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border dark:border-gray-700">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
                <Clock className="h-6 w-6 mr-2 text-orange-600 dark:text-orange-400" />
                Time Management
              </h2>
              <div className="space-y-4 text-gray-700 dark:text-gray-300">
            ...
            <section className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border dark:border-gray-700">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
                <Monitor className="h-6 w-6 mr-2 text-purple-600 dark:text-purple-400" />
                Teleprompter Operation
              </h2>
              <div className="space-y-4 text-gray-700 dark:text-gray-300">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-2 ml-4">
                      <li><kbd className="bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded">↑ Arrow Key</kbd> - Increase scroll speed</li>
                      <li><kbd className="bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded">↓ Arrow Key</kbd> - Decrease scroll speed</li>
            ...
            <section className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border dark:border-gray-700">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
                <Users className="h-6 w-6 mr-2 text-purple-600 dark:text-purple-400" />
                Team Collaboration
              </h2>
              <div className="space-y-4 text-gray-700 dark:text-gray-300">
            ...
            <section className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border dark:border-gray-700">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
                <Search className="h-6 w-6 mr-2 text-red-600 dark:text-red-400" />
                Search & Find/Replace
              </h2>
              <div className="space-y-4 text-gray-700 dark:text-gray-300">
            ...
            <section className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border dark:border-gray-700">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <ul className="space-y-1 text-gray-700 dark:text-gray-300 text-sm">
                    <li><kbd className="bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded">Ctrl + Z</kbd> - Undo</li>
                    <li><kbd className="bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded">Ctrl + C</kbd> - Copy</li>
                    <li><kbd className="bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded">Ctrl + V</kbd> - Paste</li>
                    <li><kbd className="bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded">Delete</kbd> - Delete row</li>
                  </ul>
                </div>
              </div>
            </section>
            ...
            {/* Support */}
            <section className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6 border dark:border-blue-800">
