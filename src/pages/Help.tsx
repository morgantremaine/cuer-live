      ...
      <RundownLayoutWrapper>
        <div className="max-w-4xl mx-auto py-8 px-4">
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-300">Learn how to use Cuer effectively for your broadcast productions</p>
          </div>

          <div className="space-y-8">
            {/* Getting Started */}
            <section className="bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-700">
            ...
            <section className="bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-700">
              <h2 className="text-2xl font-semibold text-white mb-4 flex items-center">
                <MousePointer className="h-6 w-6 mr-2 text-green-400" />
                Basic Operations
              </h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="font-semibold text-white mb-2">Adding Content</h3>
            ...
            <section className="bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-700">
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="font-semibold text-white mb-2">Talent Labels</h3>
                    <ul className="list-disc list-inside space-y-2 ml-4">
                      <li>Use <code className="bg-gray-700 px-2 py-1 rounded text-sm">[Talent Name]</code> to label who should read each section</li>
                      <li>Add colors by including the color name: <code className="bg-gray-700 px-2 py-1 rounded text-sm">[Talent Name {"{red}"}]</code></li>
                      <li>Available colors: red, blue, green, yellow, purple, orange, pink, cyan</li>
                      <li>Example: <code className="bg-gray-700 px-2 py-1 rounded text-sm">[John {"{blue}"}]</code> will display "John" in blue text</li>
                    </ul>
                  </div>
                  <div>
                    <h3 className="font-semibold text-white mb-2">Scroll Controls</h3>
                    <ul className="list-disc list-inside space-y-2 ml-4">
                      <li><kbd className="bg-gray-700 px-2 py-1 rounded">↑ ↓ ← → Arrow Keys</kbd> - Adjust scroll speed</li>
                      <li><kbd className="bg-gray-700 px-2 py-1 rounded">Space Bar</kbd> - Pause/Resume scrolling</li>
                      <li><kbd className="bg-gray-700 px-2 py-1 rounded">Esc</kbd> - Exit fullscreen mode</li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <section className="bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-700">
              <h2 className="text-2xl font-semibold text-white mb-4 flex items-center">
                <Search className="h-6 w-6 mr-2 text-red-400" />
                Search & Find/Replace
              </h2>
              <div className="space-y-4 text-gray-300">
            ...
            <section className="bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-700">
              <h2 className="text-2xl font-semibold text-white mb-4 flex items-center">
                <Keyboard className="h-6 w-6 mr-2 text-indigo-400" />
                Keyboard Shortcuts
              </h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="space-y-1 text-gray-300 text-sm">
                    <li><kbd className="bg-gray-700 px-2 py-1 rounded">Tab</kbd> - Next cell</li>
                    <li><kbd className="bg-gray-700 px-2 py-1 rounded">Shift + Tab</kbd> - Previous cell</li>
                    <li><kbd className="bg-gray-700 px-2 py-1 rounded">Enter</kbd> - Save and move down</li>
                    <li><kbd className="bg-gray-700 px-2 py-1 rounded">Escape</kbd> - Cancel edit</li>
                  </ul>
                </div>
                <div>
                  <h3 className="font-semibold text-white mb-2">Actions</h3>
                  <ul className="space-y-1 text-gray-300 text-sm">
                    <li><kbd className="bg-gray-700 px-2 py-1 rounded">Ctrl + Z</kbd> - Undo</li>
                    <li><kbd className="bg-gray-700 px-2 py-1 rounded">Ctrl + C</kbd> - Copy</li>
                    <li><kbd className="bg-gray-700 px-2 py-1 rounded">Ctrl + V</kbd> - Paste</li>
                    <li><kbd className="bg-gray-700 px-2 py-1 rounded">Delete</kbd> - Delete row</li>
                  </ul>
                </div>
              </div>
            </section>
            ...
            <section className="bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-700">
              ...
              <div className="space-y-4 text-gray-300">
                <div>
                  <h3 className="font-semibold text-white mb-2">Teleprompter</h3>
                ...
                <div>
                  <h3 className="font-semibold text-white mb-2">Blueprint Mode</h3>
                  <p className="text-sm">Use blueprint mode for pre-production planning with lists, crew management, and camera plots.</p>
                </div>
                <div>
                  <h3 className="font-semibold text-white mb-2">Column Customization</h3>
